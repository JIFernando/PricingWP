	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'pricing' ) . '" data-uploader_button_text="' . __( 'Use image', 'pricing' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'pricing' ) . '" />' . "\n";
